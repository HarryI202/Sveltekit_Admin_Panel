      ...
      <div class="col-md-4">
        <div class="card">
          <div class="card-body">
            ...
            <h4><b>$ 3,018</b></h4>
            <a href="/" class="btn btn-primary btn-full text-left mt-3 mb-3"
              ><i class="fa fa-plus" /> Add Balance</a
            >
          </div>
          <div class="card-footer">
            <ul class="nav">
              <li class="nav-item">
                <a class="btn btn-default btn-link" href="/"
                  ><i class="fa fa-history" /> History</a
                >
              </li>
            ...
            <div class="row">
              <div class="col-5">
                <div class="icon-big text-center">
                  <i class="fa fa-heart-o text-primary" />
                </div>
              </div>
              <div class="col-7 d-flex align-items-center">
                <div class="numbers">
                  ...
                  <tr>
                    <td>
                      <div class="form-check">
                        <label class="form-check-label">
                          <input
                            class="form-check-sign task-select"
                            type="checkbox"
                          />
                          <!-- <span class="form-check-sign"></span> -->
                        </label>
