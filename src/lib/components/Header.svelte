...
<div class="main-header">
  <div class="logo-header bg-dark">
    ...
    <button class="topbar-toggler more"><i class="fa fa-ellipsis-v" /></button>
  </div>
  <nav class="navbar navbar-header navbar-expand-lg text-black">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-user">
            ...
            <a class="dropdown-item" href="/"
              ><i class="ti-user" /> My Profile</a
            >
            <a class="dropdown-item" href="/"> My Balance</a>
            <a class="dropdown-item" href="/"><i class="ti-email" /> Inbox</a>
            <div class="dropdown-divider" />
            <a class="dropdown-item" href="/"
              ><i class="ti-settings" /> Account Setting</a
            >
            <div class="dropdown-divider" />
            <a class="dropdown-item" href="/"
              ><i class="fa fa-power-off" /> Logout</a
            >
          </ul>
        </li>
      </ul>
